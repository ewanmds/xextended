...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-extended-green selection:text-black overflow-x-hidden flex flex-col items-center relative pb-24">
      {/* Background Glows */}
      ...
      <div className="relative z-10 container mx-auto px-4 pt-16 flex flex-col items-center gap-12 w-full max-w-6xl">
